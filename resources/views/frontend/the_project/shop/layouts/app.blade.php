...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('frontend/the_project/img/ctforcabruta/logo.png')  }}">
    ...
    <!-- Bootstrap 4.* and font-awesome 5.* CSS File -->
    <link href="{{ url(mix('frontend/the_project/css/app.css')) }}" rel="stylesheet">

    <!-- Font Awesome CSS -->
    <link href="{{ asset('frontend/template/fonts/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">
    ...
    <link href="{{ asset('frontend/template/css/skins/vivid_red.css') }}" rel="stylesheet">
...
<div id="app" class="page-wrapper">
    @include('frontend.the_project.shop.layouts._partials.header')
    @include('frontend.the_project.shop.layouts._partials.content')
    @include('frontend.the_project.shop.layouts._partials.footer')
</div>
<!-- page-wrapper end -->
